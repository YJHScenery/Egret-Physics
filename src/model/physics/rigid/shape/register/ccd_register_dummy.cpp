...
static bool registerContinuousStandardShape()
{
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_BOX, TYPE_ID_STANDARD_BOX,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_BOX, TYPE_ID_STANDARD_SPHERE,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_SPHERE, TYPE_ID_STANDARD_SPHERE,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    // Box 与 其他形状
    reg.registerContinuousJudge(TYPE_ID_STANDARD_BOX, TYPE_ID_STANDARD_CYLINDER,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_BOX, TYPE_ID_STANDARD_CYLINDRICAL_SHELL,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_BOX, TYPE_ID_STANDARD_DISK,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_BOX, TYPE_ID_STANDARD_RING,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_BOX, TYPE_ID_STANDARD_ROD,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_BOX, TYPE_ID_STANDARD_SPHERICAL_SHELL,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    // Cylinder 开头的组合
    reg.registerContinuousJudge(TYPE_ID_STANDARD_CYLINDER, TYPE_ID_STANDARD_CYLINDER,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_CYLINDER, TYPE_ID_STANDARD_CYLINDRICAL_SHELL,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_CYLINDER, TYPE_ID_STANDARD_DISK,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_CYLINDER, TYPE_ID_STANDARD_RING,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_CYLINDER, TYPE_ID_STANDARD_ROD,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_CYLINDER, TYPE_ID_STANDARD_SPHERE,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_CYLINDER, TYPE_ID_STANDARD_SPHERICAL_SHELL,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_CYLINDRICAL_SHELL, TYPE_ID_STANDARD_CYLINDRICAL_SHELL,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_CYLINDRICAL_SHELL, TYPE_ID_STANDARD_DISK,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_CYLINDRICAL_SHELL, TYPE_ID_STANDARD_RING,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_CYLINDRICAL_SHELL, TYPE_ID_STANDARD_ROD,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_CYLINDRICAL_SHELL, TYPE_ID_STANDARD_SPHERE,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_CYLINDRICAL_SHELL, TYPE_ID_STANDARD_SPHERICAL_SHELL,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    // Disk 开头
    reg.registerContinuousJudge(TYPE_ID_STANDARD_DISK, TYPE_ID_STANDARD_DISK,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_DISK, TYPE_ID_STANDARD_RING,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_DISK, TYPE_ID_STANDARD_ROD,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_DISK, TYPE_ID_STANDARD_SPHERE,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_DISK, TYPE_ID_STANDARD_SPHERICAL_SHELL,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    // Ring 开头
    reg.registerContinuousJudge(TYPE_ID_STANDARD_RING, TYPE_ID_STANDARD_RING,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_RING, TYPE_ID_STANDARD_ROD,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_RING, TYPE_ID_STANDARD_SPHERE,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_RING, TYPE_ID_STANDARD_SPHERICAL_SHELL,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    // Rod 开头
    reg.registerContinuousJudge(TYPE_ID_STANDARD_ROD, TYPE_ID_STANDARD_ROD,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_ROD, TYPE_ID_STANDARD_SPHERE,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_ROD, TYPE_ID_STANDARD_SPHERICAL_SHELL,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_SPHERE, TYPE_ID_STANDARD_SPHERICAL_SHELL,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
    ...
    reg.registerContinuousJudge(TYPE_ID_STANDARD_SPHERICAL_SHELL, TYPE_ID_STANDARD_SPHERICAL_SHELL,
                                [](const ShapeBase* shapeA, const Transform& initTransA,
                                   const Eigen::Vector3d& linearVelA, const Eigen::Vector3d& angularVelA,
                                   const ShapeBase* shapeB, const Transform& initTransB,
                                   const Eigen::Vector3d& linearVelB, const Eigen::Vector3d& angularVelB,
